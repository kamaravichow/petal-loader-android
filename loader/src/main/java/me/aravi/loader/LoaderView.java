...
public final class LoaderView extends View {
    ...
    private List<Coodinator> mPetalCoordinates;
    ...
    private void init(
        ...
        Calculator calc = new Calculator(petalCount);
    ...
    private static class FlowerUpdateHandler extends Handler {
        WeakReference<LoaderView> reference;

        public FlowerUpdateHandler(LoaderView flowerView) {
            reference = new WeakReference<>(flowerView);
        }

        @Override
        public void handleMessage(Message message) {
            LoaderView flowerView = reference.get();
            if (flowerView != null) {
