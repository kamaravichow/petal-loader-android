package me.aravi.loader.progress;
...
import me.aravi.loader.Constants;
import me.aravi.loader.LoaderBase;
import me.aravi.loader.LoaderView;
import me.aravi.loader.R;

public class LoaderProgress extends LoaderBase {
    ...
    private LoaderProgress(Builder builder) {
    ...
    public void show() {
        if (mLoaderView == null) {
            ...
            mLoaderView = new LoaderView(mBuilder.mContext, size, mBuilder.mBackgroundColor, mBuilder.mBackgroundAlpha, mBuilder.mBackgroundCornerRadius
        ...
        super.setContentView(mLoaderView);
        super.show();
        ...
        mTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if (mBuilder.mDirection == Constants.DIRECT_CLOCKWISE) {
                    mLoaderView.updateFocusIndex(result);
                } else {
                    mLoaderView.updateFocusIndex(mBuilder.mPetalCount - 1 - result);
                }
                if (result == 0) {
                    mSpinCount = 1;
                } else {
    ...
    public static class Builder {
        ...
        private int mTheme = R.style.Loader;
        ...
        private int mDirection = Constants.DIRECT_CLOCKWISE;
